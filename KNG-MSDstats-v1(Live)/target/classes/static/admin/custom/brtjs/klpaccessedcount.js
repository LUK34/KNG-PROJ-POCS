...
document.addEventListener('DOMContentLoaded', function ()
{
	...
	// ----------------------------------- REPORT TYPE FILTER START -----------------------------------
	 ...
	 var form = document.getElementById('klpaccessedcount'); // Get the form by its ID
	 
	 form.addEventListener('submit', function (e) {

        e.preventDefault(); // Prevent form submission if validation fails
        var sdate = document.getElementById('sdate_klpaccessedcount').value;
        var edate = document.getElementById('edate_klpaccessedcount').value;
        var oid = document.getElementById('oid_klpaccessedcount').value;
        var rprttypeid= document.getElementById('reporttype_klpaccessedcount').value;
        var error = document.getElementById('klpaccessedcount-error-message'); // Ensure you have this element in your HTML
...
// ------------------------------------------- KNG Lab Patient Count Accessed Report Tests Taken END --------------------------------------------------------------			

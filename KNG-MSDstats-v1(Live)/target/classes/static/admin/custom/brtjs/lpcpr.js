...
// ------------------------------------------- KNG Lab Patient Count Processed Report Tests Taken START --------------------------------------------------------------			
document.addEventListener('DOMContentLoaded', function ()
{
	...
	// ----------------------------------- REPORT TYPE FILTER START -----------------------------------
	 ...
	 var form = document.getElementById('lpcpr'); // Get the form by its ID
	 
	 form.addEventListener('submit', function (e) {

        e.preventDefault(); // Prevent form submission if validation fails
        var sdate = document.getElementById('sdate_lpcpr').value;
        var edate = document.getElementById('edate_lpcpr').value;
        var oid = document.getElementById('oid_lpcpr').value;
        var rprttypeid= document.getElementById('reporttype_lpcpr').value;
        var error = document.getElementById('lpcpr-error-message'); // Ensure you have this element in your HTML
...
// ------------------------------------------- KNG Lab Patient Count Processed Report Tests Taken END --------------------------------------------------------------			

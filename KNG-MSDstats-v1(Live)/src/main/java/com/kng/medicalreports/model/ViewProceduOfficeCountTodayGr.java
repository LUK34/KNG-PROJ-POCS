...
public class ViewProceduOfficeCountTodayGr implements Serializable {
	...
	public ViewProceduOfficeCountTodayGr() {
		
	}

	
	public ViewProceduOfficeCountTodayGr(String officeName, int officeId,long totalCount) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ViewProceduOfficeCountTodayGr other = (ViewProceduOfficeCountTodayGr) obj;

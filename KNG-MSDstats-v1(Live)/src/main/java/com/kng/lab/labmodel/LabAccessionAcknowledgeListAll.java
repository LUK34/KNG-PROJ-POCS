...
@NoArgsConstructor
@AllArgsConstructor
@Table(name="VIEW_LAB_AA_LIST_ALL",catalog="ECLINIC")
public class LabAccessionAcknowledgeListAll
{
	@Id
	@Column(name="row_num")
	private int row_num;
	...
	@Column(name="ACCESSION_TIME")
	private String ACCESSION_TIME;
	
	@Column(name="ACCESSION_BY")
	private String ACCESSION_BY;
	
	@Column(name="ACCESSED_PERSON_NAME")
	private String ACCESSED_PERSON_NAME;

...
@Entity
@Table(name="VIEW_RADTEST_CLICK_ALL_V2",catalog="ECLINIC")
public class ViewRadTestInfoToday implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1192379411103816882L;
...
//	private int DOCTORS_ID;
	...
	@Column(name="PATIENT_RADTEST_COUNT")
	private Integer PATIENT_RADTEST_COUNT;
...
//	}
 ...
 public Integer getPATIENT_RADTEST_COUNT() {
		return PATIENT_RADTEST_COUNT;
	}


	public void setPATIENT_RADTEST_COUNT(Integer pATIENT_RADTEST_COUNT) {
		PATIENT_RADTEST_COUNT = pATIENT_RADTEST_COUNT;
	}
...
public String getTestNameList() {
	...
	public String toString() {
		return "ViewRadTestInfoToday [row_num=" + row_num + ", CONSULT_DATE=" + CONSULT_DATE + ", PATIENT_EMPLOYEE_ID="
				...
				+ OFFICE_ID + ", PATIENT_RADTEST_COUNT=" + PATIENT_RADTEST_COUNT + ", testNameList=" + testNameList
	...
	public int hashCode() {
		return Objects.hash(CATEGORY_NAME, CONSULT_DATE, DEPARTMENT_NAME, DOCTOR_NAME, OFFICE_ID, OFFICE_NAME,
				PATIENT_CIVILID, PATIENT_EMPLOYEE_ID, PATIENT_NAME, PATIENT_RADTEST_COUNT, TEST_NAME, categoryNameList,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ViewRadTestInfoToday other = (ViewRadTestInfoToday) obj;
		return Objects.equals(CATEGORY_NAME, other.CATEGORY_NAME) && Objects.equals(CONSULT_DATE, other.CONSULT_DATE)
				...
				&& Objects.equals(PATIENT_RADTEST_COUNT, other.PATIENT_RADTEST_COUNT)
				&& Objects.equals(TEST_NAME, other.TEST_NAME)
...
//				+ ", CATEGORY_NAME=" + CATEGORY_NAME + ", OFFICE_ID=" + OFFICE_ID + ", PATIENT_RADTEST_COUNT="
//				+ PATIENT_RADTEST_COUNT + ", testNameList=" + testNameList + ", categoryNameList=" + categoryNameList
//				+ "]";
//	}
//
//
//	@Override
//	public int hashCode() {
//		return Objects.hash(/* CATEGORY_ID, */ CATEGORY_NAME, CONSULT_DATE,
//				/* DEPARTMENT_ID, */ DEPARTMENT_NAME, /* DOCTORS_ID, */
//				DOCTOR_NAME,
//				/* LABTEST_ID, */ OFFICE_ID, OFFICE_NAME, PATIENT_EMPLOYEE_ID,
//				/* PATIENT_KWT_NKWT, */ PATIENT_NAME,
//				PATIENT_RADTEST_COUNT, TEST_NAME, categoryNameList, row_num, testNameList);
//	}
//
//
//	@Override

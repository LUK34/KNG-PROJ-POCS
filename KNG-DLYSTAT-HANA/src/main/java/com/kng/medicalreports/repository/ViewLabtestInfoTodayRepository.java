...
public interface ViewLabtestInfoTodayRepository extends JpaRepository<ViewLabtestInfoToday, Integer>{
...
//	public List<ViewLabtestInfoToday> findAllByRangeDate(String Form ,String To);
	...
	public List<ViewLabtestInfoToday> findAllByRangeDate(String Form ,String To,int ofcId);

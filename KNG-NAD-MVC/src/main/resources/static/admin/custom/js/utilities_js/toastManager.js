...
export function toastManager(message, color) 
{
  ...
  if (!color) {
    color = 'bg-info';//bg-warning ,bg-success,bg-info,bg-danger
  }
  ...
  const toastHTML = `
    <div class="toast align-items-center ${colorClass} border-0" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="7500000">
      <div class="d-flex">
